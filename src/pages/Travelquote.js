      ...
      <section className="travelquote-inner">
        <div className="footer-info-parent">
          ...
          <div className="travel-information-wrapper">
            <h2 className="travel-information8">Travel information</h2>
          </div>
          <div className="frame-parent13">
            <div className="terms-and-conditions-link-parent">
              ...
              <div className="by-signing-up-message1">
                <h2 className="travel-information9">Travel information</h2>
                <div className="waitlist-join-button-wrapper">
                  <div className="waitlist-join-button">
            ...
            <div className="call-to-action-footer-glyph-wrapper">
              <div className="call-to-action-footer-glyph">
