      ...
      <div className="progress-bar-batch">
        ...
        <div className="accordion-panel-set">
          ...
          <div className="tabbed-container1">
            ...
            <div className="splittable-pane-pair">
              <img
                className="splittable-pane-pair-child"
                loading="lazy"
                alt=""
                src="/rectangle-451@2x.png"
              />
              <img
                className="splittable-pane-pair-item"
                loading="lazy"
                alt=""
          ...
          <div className="tabbed-container2">
          ...
          <div className="tabbed-container3">
          ...
          <div className="tabbed-container4">
